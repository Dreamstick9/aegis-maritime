...
Semantic controls, visible focus, keyboard-operable core interactions (navigation, timeline, region selection), reduced-motion mode, labelled data, AA contrast on both grounds (yellow canvas, black plates).
